...
def parse_args():
    ...
    parser.add_argument('--psm_tanimoto', type=str, default='project3_data/pairwise_similarity_matrix_tanimoto.npy', help='Path to the Tanimoto similarity matrix')
    parser.add_argument('--psm_tm', type=str, default='project3_data/pairwise_similarity_matrix_tm.npy', help='Path to the TM-score similarity matrix')
    parser.add_argument('--psm_rmsd', type=str, default='project3_data/pairwise_similarity_matrix_rmsd.npy', help='Path to the RMSD similarity matrix')
    ...
    parser.add_argument('--affinity_data', type=str, default='project3_data/PDBbind_data_dict.json', help='Path to the affinity data')
    parser.add_argument('--data_split', type=str, default='project3_data/PDBbind_data_split.json', help='Path to the data split')
